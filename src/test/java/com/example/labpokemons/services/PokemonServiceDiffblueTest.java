...
class PokemonServiceDiffblueTest {
    ...
    /**
     * Method under test: {@link PokemonService#getPokemonsListByParams(String)}
     */
    @Test
    @Disabled("TODO: Complete this test")
    void testGetPokemonsListByParams() throws IOException {
        try (MockedStatic<InetAddress> mockInetAddress = mockStatic(InetAddress.class)) {
            mockInetAddress.when(() -> InetAddress.getAllByName(Mockito.<String>any())).thenReturn(new InetAddress[]{});
            pokemonService.getPokemonsListByParams("Name");
        }
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        //   java.net.UnknownHostException: okhttp3.Dns$Companion$DnsSystem@609142e2 returned no addresses for pokeapi.co
        ...
        //       at com.example.labpokemons.services.PokemonService.getPokemonsListByParams(PokemonService.java:42)
